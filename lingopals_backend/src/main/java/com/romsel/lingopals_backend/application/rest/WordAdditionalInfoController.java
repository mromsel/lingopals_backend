...
import com.romsel.lingopals_backend.application.response.WordAdditionalInfoDto;
import com.romsel.lingopals_backend.domain.entities.languages_content.WordAdditionalInfo;
import com.romsel.lingopals_backend.domain.services.WordAdditionalInfoService;
import com.romsel.lingopals_backend.domain.services.WordService;
